...
<div class="jo-block-gift-modal">
    ...
    <div class="jo-block-gift-modal__details">
        ...
        <div class="jo-block-gift-modal__details--custom-amount">
            ...
            <input type="number" name="custom-amount" id="custom-amount" placeholder="<?php _e('ex : 100€', 'jourj-gifts'); ?>" min="1" step="0.01" required />
        </div>
    </div>
...
<div class="jo-block-gift-modal__overlay"></div>